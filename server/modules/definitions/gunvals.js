module.exports = {
    ...
    subduer: { reload: 1.3, shudder: 0.85, health: 0.8, pen: 0.85, damage: 0.7, speed: 1.05, maxSpeed: 0.8, density: 1.1, resist: 1.07 },
    subduer2: { reload: 1.3, shudder: 0.85, health: 1.4, pen: 0.55, damage: 0.75, speed: 1.05, maxSpeed: 0.8, density: 1.1, resist: 1.07 },
    subduer3: { reload: 1.3, health: 1.4, pen: 1.3, speed: 1.05, maxSpeed: 0.8, density: 1.1, resist: 1.07 },
    ...
    nail: { reload: 0.85, recoil: 2.5, size: 0.8, damage: 0.6, density: 2 },
    pellet: { reload: 1, recoil: 1, size: 0.8, damage: 0.7 },
