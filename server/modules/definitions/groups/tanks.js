    ...
    GUNS: [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.subduer, g.lessreload]),
          TYPE: "bullet",
        },
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.subduer2, g.lessreload]),
          TYPE: "bullet",
        },
      },
    ],
...
exports.bentHewnDouble = {
    PARENT: ["genericTank"],
    LABEL: "Bent Hewn Double",
    DANGER: 7,
    GUNS: [
       {
            /*** LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
            POSITION: [16, 8, 1, 0, -2, -220, 0.75],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.bent, g.double, g.morerecoil]),
                TYPE: "bullet",
            },
        },
        { 
...
exports.xStack = {
    ...
    CONTROLLERS: [["zoom", { distance: 425 }]],
    TOOLTIP: "Hold right click to zoom.",
    GUNS: [
        {
        POSITION: [23, 6, 1, 0, 0, 0, 0],
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.subduer, g.lessreload, g.halfrecoil]),
          TYPE: "bullet",
        },
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.subduer2, g.lessreload, g.halfrecoil]),
          TYPE: "bullet",
        },
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.subduer3, g.lessreload, g.halfrecoil]),
          TYPE: "bullet",
        },
      },
        {
            POSITION: [5, 10.5, -1.35, 7, 0, 0, 0],
        },
    ],
};
  exports.subguard = {
...
exports.stack = {
  ...
  exports.twinstack = {
    ...
    GUNS: [
      {
        /*** LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
        POSITION: [23, 5, 1, 0, -5, 0, 0],
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.subduer, g.halfreload, g.halfrecoil]),
          TYPE: "bullet",
        },
      },
      {
        /* LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
        POSITION: [20, 7, 1, 0, -5, 0, 0.1],
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.subduer2, g.halfreload, g.halfrecoil]),
          TYPE: "bullet",
        },
      },
      {
        /* LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
        POSITION: [17, 9, 1, 0, -5, 0, 0.2],
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.subduer3, g.halfreload, g.halfrecoil]),
          TYPE: "bullet",
        },
      },
      {
        /*** LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
        POSITION: [23, 5, 1, 0, 5, 0, 0.5],
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.subduer, g.halfreload, g.halfrecoil]),
          TYPE: "bullet",
        },
  ...
  exports.fourstack = {
    ...
    GUNS: [
      ...
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.subduer3, g.lessreload]),
          TYPE: "bullet",
        },
      },
      {
        /* LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
        POSITION: [17, 12, 1, 0, 0, 0, 0.3],
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.subduer3, g.lessreload]),
          TYPE: "bullet",
        },
...
exports.lurk = makeHybrid(exports.stack, "Lurker");
exports.pentabrid = makeHybrid(exports.pentaShot, "Pentabrid");
exports.pelletbrid = makeHybrid(exports.pelleter, "Fisher");

exports.overduer = makeOver(exports.sub, "Overduer");
exports.overbent = makeOver(exports.tripleShot, "Overtriple Shot");

exports.autosub = makeAuto(exports.sub, "Auto Subduer");
exports.locate = makeAuto(exports.camper, "Locator");
exports.autosubguard = makeAuto(exports.subguard, "Auto Subduer Flank");
exports.autotwinsub = makeAuto(exports.twinsub, "Tandem");
exports.autostack = makeAuto(exports.stack, "Compresser");
exports.autobentdouble = makeAuto(exports.bentDouble, "Auto Bent Double");
exports.autotriple = makeAuto(exports.tripleTwin, "Auto Triple Twin");
exports.autohewndouble = makeAuto(exports.hewnDouble, "Auto Hewn Double");
exports.autopenta = makeAuto(exports.pentaShot, "Auto Penta Shot");
exports.autobase = makeAuto(exports.basic);
exports.autotwin = makeAuto(exports.twin);
exports.autosniper = makeAuto(exports.sniper);
exports.automachine = makeAuto(exports.machineGun);
exports.autoflank = makeAuto(exports.flankGuard);
...
exports.autopelletbrid = makeAuto(exports.pelletbrid);
exports.autopelleter = makeAuto(exports.pelleter);


// TANK UPGRADE PATHS
exports.basic.UPGRADES_TIER_1 = ["twin", "sniper", "machineGun", "flankGuard", "director", "pounder", "trapper", "sub", "autobase", "pelleter"];
    exports.basic.UPGRADES_TIER_2 = ["smasher", "healer"];
    ...
    exports.twin.UPGRADES_TIER_2 = ["doubleTwin", "tripleShot", "gunner", "twinsub", "autotwin"];
        exports.twin.UPGRADES_TIER_3 = ["bulwark", "musket"];
        exports.doubleTwin.UPGRADES_TIER_3 = ["tripleTwin", "hewnDouble", "autoDouble", "bentDouble"];
            exports.tripleTwin.UPGRADES_TIER_4 = ["quadTwin", "bentTriple", "autotriple"];
            exports.bentDouble.UPGRADES_TIER_4 = ["bentTriple", "autobentdouble", "bentHewnDouble"];
            exports.autoDouble.UPGRADES_TIER_4 = ["autotriple", "autohewndouble", "autobentdouble"];
            exports.hewnDouble.UPGRADES_TIER_4 = ["skewnDouble", "hewnTriple", "hewnFlank", "autohewndouble", "bentHewnDouble"];
        exports.tripleShot.UPGRADES_TIER_3 = ["pentaShot", "spreadshot", "bentHybrid", "bentDouble", "triplet", "trisub"];
            exports.pentaShot.UPGRADES_TIER_4 = ["septaShot", "pentasub", "pentabrid"];
            exports.bentHybrid.UPGRADES_TIER_4 = ["overbent", "pentabrid"];
    ...
    exports.sniper.UPGRADES_TIER_2 = ["assassin", "hunter", "minigun", "rifle", "autosniper"];
        ...
        exports.hunter.UPGRADES_TIER_3 = ["predator", "xHunter", "poacher", "ordnance", "dual", "hunterflank"];
        exports.rifle.UPGRADES_TIER_3 = ["musket", "crossbow", "armsman"];

    exports.machineGun.UPGRADES_TIER_2 = ["artillery", "minigun", "gunner", "sprayer", "automachine"];
        exports.minigun.UPGRADES_TIER_3 = ["streamliner", "cropDuster", "barricade", "vulture"];
        exports.gunner.UPGRADES_TIER_3 = ["autoGunner", "auto4", "machineGunner", "cyclone"];
        exports.sprayer.UPGRADES_TIER_3 = ["redistributor", "phoenix", "atomizer", "focal"];

    exports.flankGuard.UPGRADES_TIER_2 = ["hexaTank", "triAngle", "auto3", "trapGuard", "triTrapper", "subguard", "autoflank"];
        exports.flankGuard.UPGRADES_TIER_3 = ["tripleTwin"];
        exports.hexaTank.UPGRADES_TIER_3 = ["octoTank", "cyclone", "hexaTrapper", "subguardhex"];
        exports.triAngle.UPGRADES_TIER_3 = ["fighter", "booster", "falcon", "bomber", "hewnDouble", "autoTriAngle", "surfer", "eagle", "phoenix", "vulture"];
    ...
    exports.director.UPGRADES_TIER_2 = ["overseer", "cruiser", "underseer", "spawner", "autodirector"];
        ...
        exports.overseer.UPGRADES_TIER_3 = ["overlord", "overtrapper", "overgunner", "overduer", "overbent", "banshee", "autoOverseer", "overdrive", "commander"];
    ...
    exports.pounder.UPGRADES_TIER_2 = ["destroyer", "builder", "artillery", "launcher", "autopounder"];
    ...
    exports.trapper.UPGRADES_TIER_2 = ["builder", "triTrapper", "trapGuard", "autotrapper"];
    ...
    exports.sub.UPGRADES_TIER_2 = ["hunter", "sprayer", "minigun", "twinsub", "subguard", "camper", "stack", "autosub", "xSub"];
        exports.twinsub.UPGRADES_TIER_3 = ["dual", "trisub", "twinstack", "ambush", "autotwinsub"];
            exports.trisub.UPGRADES_TIER_4 = ["pentasub"];
        exports.subguard.UPGRADES_TIER_3 = ["subguardhex", "hunterflank", "autosubguard"];
        exports.camper.UPGRADES_TIER_3 = ["overduer", "poacher", "locate", "ambush", "lurk"];
        exports.stack.UPGRADES_TIER_3 = ["predator", "fourstack", "twinstack", "lurk", "autostack", "xStack"];
        exports.autosub.UPGRADES_TIER_3 = ["autotwinsub", "autosubguard", "locate", "autostack"]
        exports.xSub.UPGRADES_TIER_3 = ["xHunter", "xStack"];

    exports.autobase.UPGRADES_TIER_2 = ["autotwin", "autosniper", "automachine", "autoflank", "autodirector", "autopounder", "autotrapper", "autosub"];
        exports.autotwin.UPGRADES_TIER_3 = ["autoDouble", "autoGunner"];
        exports.autosniper.UPGRADES_TIER_3 = ["autoAssassin"];
        exports.automachine.UPGRADES_TIER_3 = ["autoGunner"];
        exports.autoflank.UPGRADES_TIER_3 = ["autoTriAngle", "autosubguard"];
        exports.autodirector.UPGRADES_TIER_3 = ["autoOverseer", "autoCruiser", "autoSpawner"];
        exports.autotrapper.UPGRADES_TIER_3 = ["autoBuilder", "hexaTrapper"];

    exports.pelleter.UPGRADES_TIER_2 = ["gunner", "nailgun", "pelletbrid", "autopelleter"];
        exports.pelleter.UPGRADES_TIER_3 = ["gunnerTrapper"];
        exports.nailgun.UPGRADES_TIER_3 = ["punter"];
        exports.pelletbrid.UPGRADES_TIER_3 = ["overgunner", "autopelletbrid"];
        exports.autopelleter.UPGRADES_TIER_3 = ["autoGunner", "autopelletbrid"];
